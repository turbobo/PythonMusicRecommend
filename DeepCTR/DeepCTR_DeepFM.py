...
# Keras == 2.3.1 和 tensorflow==2.2.0
...
#                l2_reg_linear=0.1, l2_reg_embedding=0.1, l2_reg_dnn=0,
#                task='regression')
# 部分交叉、全部交叉
fm_group_part = ("year", "artist_hotttnesss")
fm_group_all = ("user", "song", "artist_hotttnesss", "year", 'duration')

# model = DeepFM(linear_feature_columns, dnn_feature_columns, fm_group=fm_group_all,
#                dnn_hidden_units=(256, 256, 256), task='regression')
# model = DeepFM(linear_feature_columns, dnn_feature_columns, fm_group=fm_group_all,
#              l2_reg_linear=0.01, l2_reg_embedding=0.01, l2_reg_dnn=0,
#              task='regression')

model = DeepFM(linear_feature_columns, dnn_feature_columns,
               fm_group=fm_group_all,
               task='regression')

# model = DeepFM(linear_feature_columns, dnn_feature_columns, fm_group=fm_group_all, task='regression')
# model = DeepFM(linear_feature_columns, dnn_feature_columns, dnn_dropout=0.9, task='regression')
