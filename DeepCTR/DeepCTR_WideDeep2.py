from DeepCTR.deepctr_torch.models import WDL
...
from .util.utils import check_model
...
# model = WDL(linear_feature_columns, dnn_feature_columns, dnn_activation='prelu',
#             dnn_hidden_units=[32, 32], dnn_dropout=0.5, device='cpu')
