# -*- coding: utf-8 -*-
"""deep&wide_rating_200w.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eGOyLr5qada30dWXFFWJ0iCPVm3Ch9fF
"""
...
# model.fit(dataset=train_dataset, n_epochs=50, batch_size=128)
model.fit(dataset=train_dataset, n_epochs=5, batch_size=128)

# 调参
# model.fit(dataset=train_dataset, n_epochs=30, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=60, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=80, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=100, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=150, batch_size=128)
...
#获取测试MSE
mean_squared_error(y_pred,y)   #  0.04385730292396423

#获取测试MAE
mean_absolute_error(y_pred,y)  # 0.1855348550783847
...
for droupout in droupouts:
    ...
    if use_cuda:
        model = model.cuda()
    model.fit(dataset=train_dataset, n_epochs=3, batch_size=128)
    # 调参
    # model.fit(dataset=train_dataset, n_epochs=5, batch_size=128)
...
# 调参
# model.fit(dataset=train_dataset, n_epochs=50, batch_size=128)
model.fit(dataset=train_dataset, n_epochs=10, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=30, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=30, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=60, batch_size=128)
# model.fit(dataset=train_dataset, n_epochs=100, batch_size=128)
...
# plt.plot(np.arange(100),model.loss_values)
# plt.plot(np.arange(60),model.loss_values)
# plt.plot(np.arange(150),model.loss_values)
plt.ylabel('Train Error')
plt.xlabel('epoch')
...
#         model = model.cuda()
#     train_dataset = data_processed['train_dataset']
#     model.fit(dataset=train_dataset, n_epochs=1, batch_size=128)
#     end_time = time.time()
